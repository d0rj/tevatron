class TrainPreProcessor:
    ...
    def __call__(self, example):
        ...
        for pos in example['positive_passages']:
            text = pos['title'] + self.separator + pos['text'] if 'title' in pos and pos['title'] is not None else pos['text']
        ...
        for neg in example['negative_passages']:
            text = neg['title'] + self.separator + neg['text'] if 'title' in neg and neg['title'] is not None else neg['text']
...
class CorpusPreProcessor:
    ...
    def __call__(self, example):
        docid = example['docid']
        text = example['title'] + self.separator + example['text'] if 'title' in example and example['title'] is not None else example['text']
